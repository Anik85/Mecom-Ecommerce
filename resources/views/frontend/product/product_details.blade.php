                ...
                <div class="wrap-product-detail">
                    ...
                    <div class="detail-info">
                        ...
                        <div class="wrap-social">
                            <a class="link-socail" href="#"><img src="{{asset('ui/frontend/assets/images/social-list.png')}}" alt=""></a>
                        </div>
                        <div class="wrap-price"><span class="product-price">Price: {{$product->selling_price}}</span></div>
                        ...
                        <div class="quantity">
                            ...
                            <div class="quantity-input">
                                <input type="text" name="product-quatity" value="1" data-max="{{ $product->product_qty }}" pattern="[0-9]*" >
                            ...
                            <div class="product product-style-2 equal-elem ">
                                <div class="product-thumnail">
                                    <a href="detail.html" title="T-Shirt Raw Hem Organic Boro Constrast Denim">
                                        <figure><img src="{{asset($product->product_image)}}" width="214" height="214" alt="T-Shirt Raw Hem Organic Boro Constrast Denim"></figure>
                                    </a>
