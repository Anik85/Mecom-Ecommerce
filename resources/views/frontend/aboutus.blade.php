				...
				<div class="container">
					<div class="mid-section main-info-area">
						...
						<div class="wrap-logo-top left-section">
							<a href="{{ route('homepage') }}" class="link-to-home"><img src="{{ asset('ui/frontend/assets/images/logo-top-1.png') }}" alt="mercado"></a>
						</div>
						...
						<div class="container">
							<ul class="nav primary clone-main-menu" id="mercado_main" data-menuname="Main menu" >
								...
								<li class="menu-item home-icon">
									<a href="about-us.html" class="link-term mercado-item-title" style="color: white;!important">About Us</a>
								</li>
								<li class="menu-item">
